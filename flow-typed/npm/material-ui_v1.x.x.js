...
declare module 'material-ui/styles/createMuiTheme' {
	declare module.exports: (options: { [key: string]: { [key: string]: string } }) => {
...
declare module 'material-ui/styles' {
	declare module.exports: {
		...
		createGenerateClassName: $Exports<'material-ui/styles/createGenerateClassName'>,
	};
}
...
declare module 'material-ui/styles/withStyles' {
	...
	declare module.exports: (
		...
		options?: Options
	) => <Props: {}>(Component: React$ComponentType<Props>) => React$ComponentType<$Diff<Props, { classes?: Object }>>;
}
